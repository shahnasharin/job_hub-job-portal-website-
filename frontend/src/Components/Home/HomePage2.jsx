  ...
  return (
    <div className="p-5">
      <div className="max-w-sm p-6 bg-gray-100 border border-gray-100 rounded-lg shadow dark:bg-white-800 dark:border-gray-700">
        ...
        <a
          href="#"
          className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-orange-400 rounded-lg hover:bg-orange-600 focus:ring-4 focus:outline-none focus:ring-orange-300 dark:bg-orange-600 dark:hover:bg-orange-800 dark:focus:ring-orange-500"
        >
          Read more
          <svg
